...
knitr::include_graphics(file.path(mainPath,'/figures', "MIK_LogNormal_IBTS0 TS.png")) 
```
...
knitr::include_graphics(file.path(mainPath,'/figures', "MIK_LogNormal_cor.png")) 
```
...
knitr::include_graphics(file.path(mainPath,'/figures', "MIK_LogNormal_cor best.png")) 
```
...
knitr::include_graphics(file.path(mainPath,'/figures', "MIK_LogNormal_cor and components.png")) 
```
